...
public class CustomersManipulationPage extends JPanel implements PageUI{
    ...
    public CustomersManipulationPage() {
        setup();
    }
    ...
    public void showResult(ArrayList<Customers> customers){
        child = new JFrame();
        ...
        String [][] data = StringUtils.getCustomersInArray(customers);
